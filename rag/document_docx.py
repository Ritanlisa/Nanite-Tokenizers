...
DOCX_CHUNK_CHARS = 1200
DOCX_CHUNK_OVERLAP = 180
...
def _split_text_chunks(text: str, chunk_chars: int = DOCX_CHUNK_CHARS, overlap_chars: int = DOCX_CHUNK_OVERLAP) -> List[str]:
...
class DocxRAGDocument(RAG_DB_Document):
    def __init__(self, source_document: Document, stable_doc_id: str) -> None:
        ...
        self.source_extension = _detect_source_extension(metadata) or ".docx"
