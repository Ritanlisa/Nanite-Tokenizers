...
def _split_text_chunks(text: str, chunk_chars: int = DOC_CHUNK_CHARS, overlap_chars: int = DOC_CHUNK_OVERLAP) -> List[str]:
...
class DocRAGDocument(RAG_DB_Document):
    def __init__(self, source_document: Document, stable_doc_id: str) -> None:
        ...
        self.source_extension = _detect_source_extension(metadata) or ".doc"
